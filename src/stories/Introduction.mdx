...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Render function for each slide. Receives <code>{'{ item }'}</code> as argument. You can
        render just an img or any other React element.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Async function to fetch items. Must return <code>{'{ total, items }'}</code>.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Number of items requested per fetch call. Data is fetched preemptively as the user
        navigates, ensuring smooth transitions.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>Hide the index badge in the top right corner.</td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Show navigation arrows. Also enabled when <code>renderArrow</code> is provided.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>Custom render function for arrows.</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Custom render function for the index badge.</td>
    </tr>
  </tbody>
</table>
